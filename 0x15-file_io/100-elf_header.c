...
Void print_osabi_more(E1f64_Ehdr h);
...
/**
  ...
  * @h: the ELF header struct
  */
 void print_version(E1f64_Ehdr h)
 {
     ...
     |switch (h.e_ident[EI_OSABI])
      {
         ...
         case ELFOSABI_ARM:
                   ...
                   break;
         default:
                   printf("<unknown: %x>", h.e_ident[EI OSABI]);
                   break;
      }  
